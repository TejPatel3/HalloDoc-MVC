...
namespace DataAccess.ServiceRepository
{
    public class JwtRepository : IJwtRepository
    {
        ...
        public string GenerateJwtToken(LogedInUserViewModel loggedInPerson)
        {
            var claims = new List<Claim>
            {
                new Claim("AspNetId" , loggedInPerson.AspNetUserId),
                new Claim("UserName" , loggedInPerson.UserName),
                new Claim("Role" , loggedInPerson.RoleName)
            };
